    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans selection:bg-[#0ad150] selection:text-black">
      ...
      <main className="w-full px-6 md:px-16 lg:px-24 2xl:px-40 py-16 mx-auto">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 2xl:gap-12 mb-32">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6 2xl:space-y-8">
                <div className="group/item cursor-pointer">
                  <p className="text-[10px] 2xl:text-xs font-mono uppercase tracking-widest opacity-50 mb-1 group-hover/item:text-[#0ad150] transition-colors">General</p>
                  <p className="font-black text-xl 2xl:text-2xl tracking-tighter">kontakt@zounk.pl</p>
                </div>
                <div className="group/item cursor-pointer">
                  <p className="text-[10px] 2xl:text-xs font-mono uppercase tracking-widest opacity-50 mb-1 group-hover/item:text-[#0ad150] transition-colors">Business</p>
          ...
          <div className="group bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-10 2xl:p-16 rounded-[3rem] shadow-xl transition-all duration-500 hover:-translate-y-2">
            ...
            <div className="grid grid-cols-2 gap-4 2xl:gap-6">
              {['Twitter', 'Instagram', 'Facebook', 'LinkedIn'].map((platform) => (
                <div key={platform} className="bg-zinc-50 dark:bg-zinc-800/50 p-6 2xl:p-8 rounded-2xl text-center group/social hover:bg-[#0ad150] transition-all duration-300 cursor-pointer">
          ...
          {/* RESPONSE INFO CARD */}
          <div className="group bg-[#0ad150] text-black p-10 2xl:p-16 rounded-[3rem] shadow-xl shadow-[#0ad150]/20 relative overflow-hidden transition-all duration-500 hover:-translate-y-2">
            ...
            <form className="space-y-8 relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    type="text"
                    className="w-full px-6 py-4 2xl:py-6 bg-zinc-100 dark:bg-zinc-800 rounded-2xl font-bold text-sm text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-[#0ad150] transition-all border-none"
              ...
              <div className="space-y-2">
                ...
                <select className="w-full px-6 py-4 2xl:py-6 bg-zinc-100 dark:bg-zinc-800 rounded-2xl font-bold text-sm text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-[#0ad150] appearance-none transition-all">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  rows={4}
                  className="w-full px-6 py-4 2xl:py-6 bg-zinc-100 dark:bg-zinc-800 rounded-2xl font-bold text-sm text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-[#0ad150] transition-all resize-none border-none"
              ...
              <button
                type="submit"
                className="w-full bg-black dark:bg-white text-white dark:text-black px-8 py-5 2xl:py-7 rounded-2xl font-black text-xs 2xl:text-sm uppercase tracking-widest hover:bg-[#0ad150] dark:hover:bg-[#0ad150] hover:text-black transition-all duration-500 shadow-xl"
              >
                Send Message →
              </button>
            </form>
        ...
        <section className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 2xl:gap-12">
            {[
              ...
              <div key={idx} className="group p-8 2xl:p-12 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] hover:border-[#0ad150] transition-all duration-300">
                <h3 className="text-lg 2xl:text-xl font-black mb-4 uppercase italic tracking-tighter flex items-center gap-3">
                  <span className="text-[#0ad150] font-mono text-xs 2xl:text-sm">0{idx + 1}</span>
                  {item.q}
                </h3>
        ...
        <section className="text-center py-20 2xl:py-32 bg-zinc-950 dark:bg-zinc-50 rounded-[4rem] text-white dark:text-black relative overflow-hidden group">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center relative z-10 px-6">
            <Link
              href="/battles"
              className="bg-[#0ad150] text-black px-10 py-5 2xl:px-14 2xl:py-7 rounded-2xl font-black text-sm 2xl:text-base uppercase tracking-widest hover:scale-105 transition-all duration-500 shadow-xl"
            >
              Start a Battle
            </Link>
            <Link
