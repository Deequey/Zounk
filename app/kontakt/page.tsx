        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 2xl:gap-12 mb-32">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6 2xl:space-y-8">
                <div className="group/item cursor-pointer">
                  <p className="text-[10px] 2xl:text-xs font-mono uppercase tracking-widest opacity-50 mb-1 group-hover/item:text-[#1DB954] transition-colors">Główny</p>
                  <p className="font-black text-xl 2xl:text-2xl tracking-tighter">kontakt@zounk.pl</p>
                </div>
                <div className="group/item cursor-pointer">
                  <p className="text-[10px] 2xl:text-xs font-mono uppercase tracking-widest opacity-50 mb-1 group-hover/item:text-[#1DB954] transition-colors">Biznes</p>
          ...
          <div className="group bg-[#1DB954] text-black p-10 2xl:p-16 rounded-[3rem] shadow-xl shadow-[#1db954]/20 relative overflow-hidden transition-all duration-500 hover:-translate-y-2">
            <div className="relative z-10 h-full flex flex-col justify-between">
              <h3 className="text-2xl 2xl:text-3xl font-black mb-6 uppercase italic tracking-tighter">Dostępność.</h3>
              <div className="text-center my-4">
                <div className="text-8xl 2xl:text-9xl font-black italic tracking-tighter leading-none mb-2">24h</div>
                <p className="text-[10px] 2xl:text-xs font-black uppercase tracking-[0.2em] opacity-70">Czas Odpowiedzi</p>
              </div>
          ...
          <div className="space-y-8 2xl:space-y-12">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-5xl md:text-6xl 2xl:text-7xl font-black uppercase italic tracking-tighter leading-tight">Wyślij<br/>Wiadomość.</h2>
              </div>
            ...
            <form className="space-y-8 relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] 2xl:text-xs font-black uppercase tracking-[0.2em] text-zinc-400 ml-2">Imię</label>
                  <input
                    type="text"
              ...
              <div className="space-y-2">
                <label className="text-[10px] 2xl:text-xs font-black uppercase tracking-[0.2em] text-zinc-400 ml-2">Temat</label>
              ...
              <div className="space-y-2">
                <label className="text-[10px] 2xl:text-xs font-black uppercase tracking-[0.2em] text-zinc-400 ml-2">Wiadomość</label>
                <textarea
                  rows={4}
