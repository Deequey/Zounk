        ...
        <section className="mb-32">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6 px-4">
            <div>
              ...
              <div className="w-32 h-2 bg-[#0ad150] mt-4"></div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 2xl:gap-12">
            ...
            <div className="group relative bg-zinc-950 dark:bg-zinc-50 text-white dark:text-black p-12 lg:p-16 rounded-[3rem] overflow-hidden transition-all duration-500 hover:-translate-y-4 shadow-2xl">
              <div className="relative z-10">
                <div className="text-5xl font-black mb-8 opacity-20 group-hover:text-[#0ad150] group-hover:opacity-100 transition-all">01</div>
            ...
            {/* FEATURE 2 */}
            <div className="group relative bg-[#0ad150] text-black p-12 lg:p-16 rounded-[3rem] overflow-hidden transition-all duration-500 hover:-translate-y-4 shadow-xl shadow-[#0ad150]/20">
              <div className="relative z-10">
            ...
            <div className="group relative bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-12 lg:p-16 rounded-[3rem] overflow-hidden transition-all duration-500 hover:-translate-y-4 shadow-xl">
              <div className="relative z-10">
                <div className="text-5xl font-black mb-8 opacity-20 group-hover:text-[#0ad150] group-hover:opacity-100 transition-all">03</div>
                ...
                <div className="w-full h-1 bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden mt-auto">
                  <div className="w-2/3 h-full bg-[#0ad150] group-hover:w-full transition-all duration-1000"></div>
                </div>
              </div>
        ...
        <section className="bg-zinc-900 dark:bg-zinc-100 text-white dark:text-black p-16 md:p-24 2xl:p-32 rounded-[4rem] relative overflow-hidden mb-32 group">
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center">
            <div className="space-y-2">
              <div className="text-7xl 2xl:text-8xl font-black italic tracking-tighter group-hover:text-[#0ad150] transition-colors">2k+</div>
              <p className="text-[10px] 2xl:text-xs font-bold uppercase tracking-[0.3em] opacity-50">Active Users</p>
            </div>
            <div className="space-y-2">
              <div className="text-7xl 2xl:text-8xl font-black italic tracking-tighter group-hover:text-[#0ad150] transition-colors">50M</div>
              <p className="text-[10px] 2xl:text-xs font-bold uppercase tracking-[0.3em] opacity-50">Tracks Judged</p>
            </div>
            <div className="space-y-2">
              <div className="text-7xl 2xl:text-8xl font-black italic tracking-tighter group-hover:text-[#0ad150] transition-colors">1k</div>
              <p className="text-[10px] 2xl:text-xs font-bold uppercase tracking-[0.3em] opacity-50">Battles Fought</p>
            </div>
            <div className="space-y-2">
              <div className="text-7xl 2xl:text-8xl font-black italic tracking-tighter group-hover:text-[#0ad150] transition-colors">24/7</div>
              <p className="text-[10px] 2xl:text-xs font-bold uppercase tracking-[0.3em] opacity-50">Always Live</p>
            </div>
          </div>
          {/* Animated decorative circle */}
          <div className="absolute -top-24 -left-24 w-64 h-64 bg-[#0ad150] rounded-full blur-[120px] opacity-20 group-hover:opacity-40 transition-opacity" />
        </section>


        {/* FINAL CTA */}
        <section className="text-center py-20 border-t border-zinc-200 dark:border-zinc-800">
          <p className="font-mono text-[10px] uppercase tracking-widest text-[#0ad150] mb-4">Ready?</p>
          <h2 className="text-5xl md:text-7xl font-black tracking-tighter italic uppercase mb-10">Prove your taste.</h2>
          <Link
            href="/stats"
            className="inline-block bg-black dark:bg-white text-white dark:text-black px-12 py-6 rounded-full font-black text-lg uppercase tracking-widest hover:scale-105 hover:bg-[#0ad150] dark:hover:bg-[#0ad150] hover:text-black transition-all duration-500"
          >
            Start for Free →
          </Link>
        </section>
